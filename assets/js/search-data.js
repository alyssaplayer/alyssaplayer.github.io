      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-predicting-key-profit-drivers-from-us-e-commerce-records",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/AlyssaPlayer_DataScientist_Resume2026.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61%6C%79%73%73%61%31%38%70%6C%61%79%65%72@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/alyssaplayer", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/alyssaplayer", "_blank");
        },
      },{
      id: 'light-theme',
